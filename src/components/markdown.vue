<template>
    <div class="mdContainer" :class="{ fullPage: fullPageStatus }">
        <div class="navContainer" v-if="navStatus">
            <div class="nameContainer" v-if="icoStatusP">markDown</div>
...
<script>
    ...
    import hljs from '../common/js/highlight.min'
    import range from '../common/js/rangeFn'
    Vue.use(scroll)
    marked.setOptions({
    ...
    export default {
        ...
        methods: {
            ...
            addImage: function(evt) {
                insertContent("![weiew](http://e.weiew.net/images/logo.png)", this);
            },
        ...
        watch: {
            ...
            input: function() {
                ...
                let mdEditorEL = document.querySelector('.mdEditor')
                if(mdEditorEL){
                  let previewContainerEL = document.querySelector('.previewContainer');
                  let maxEditScrollHeight= mdEditorEL.scrollHeight-mdEditorEL.clientHeight;
                  let maxPreviewScrollHeight=previewContainerEL.scrollHeight-previewContainerEL.clientHeight;
                  this.maxEditScrollHeight = maxEditScrollHeight
                  this.maxPreviewScrollHeight = maxPreviewScrollHeight
                }
            }
...
<style lang="scss">
    /*引入reset文件*/
    @import "../assets/css/markdown/reset";
    /*!*引入github的markdown样式文件*!*/
    @import "../assets/css/markdown/github-markdown.css";
    /*!*引入atom的代码高亮样式文件*!*/
    @import "../assets/css/markdown/atom-one-dark.min.css";
    .mdContainer {
        width: 100%;
        height: 100%;
